...
internal class FileAccessStream : Stream
{
    ...
    /// <summary>
    /// Flushes any buffered _data to the file.
    ...
    /// <param name="offset">The zero-based byte offset in buffer at which to begin storing the _data read from the current stream.</param>
