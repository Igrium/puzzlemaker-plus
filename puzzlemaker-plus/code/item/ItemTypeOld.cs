...
/// </summary>
public sealed class ItemTypeOld
{
    ...
    public Dictionary<string, ItemVariantOld> Variants { get; set; } = new Dictionary<string, ItemVariantOld>();
...
public sealed class ItemVariantOld
{
    /// <summary>
    ...
    public List<ItemVariantThemeOld> Themes { get; set; } = new();
    ...
    public ItemVariantThemeOld? GetVariantTheme(string levelTheme)
    {
...
public sealed class ItemVariantThemeOld
{
    /// <summary>
